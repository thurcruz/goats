...
export default function HomePage() {
  return <main className="marketing-page overflow-hidden">
    <nav className="marketing-nav">
      <Link href="/" className="brand-mark"><span>G</span><strong>GOATS</strong></Link>
    ...
    <section className="hero-section">
      <div className="hero-orb" aria-hidden="true"><span>G</span></div>
      ...
      <div className="hero-visual" aria-label="Prévia do produto GOATS">
        ...
        <div className="floating-card ai-card"><span><Bot size={17}/></span><div><small>GOAT AI</small><p>“Seu melhor ritmo acontece pela manhã.”</p></div></div>
      </div>
    </section>
    ...
    <section id="metodo" className="manifesto-section"><div><p className="section-label">A JORNADA GOATS</p><h2>Entender. Decidir.<br/>Agir. Medir. <em>Evoluir.</em></h2></div><div className="manifesto-copy"><p>Você não precisa virar outra pessoa para começar. Precisa de um sistema que entenda quem você é hoje e ajude a construir quem deseja ser.</p><Link href="/cadastro">Começar minha evolução <ArrowRight size={17}/></Link></div></section>
    <footer id="privacidade" className="marketing-footer"><div className="brand-mark"><span>G</span><strong>GOATS</strong></div><p>Privado por padrão. Feito para a sua evolução.</p><p>© 2026 GOATS</p></footer>
  </main>
}
